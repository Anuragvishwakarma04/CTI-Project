...
export default function AddVehiclePage() {
  ...
  const isAnyImageUploading = Object.values(uploadingImages).some((v) => v);
  ...
  const handleVariantChange = (variantId: string) => {
    ...
    if (variant) {
      setFormData((prev) => ({
        ...
        transmission:
          variant.transmission?.transmission_type?.toLowerCase() || "",
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        const newFormData = {
          ...
          reconditioningCost:
            parseFloat(data.reconditioning_cost)?.toString() || "",
          accessoriesCost: parseFloat(data.accessories_cost)?.toString() || "",
          otherExpenses: parseFloat(data.other_expenses)?.toString() || "",
          expectedSellingPrice:
            parseFloat(data.expected_selling_price)?.toString() || "",
          minimumSellingPrice:
            parseFloat(data.minimum_selling_price)?.toString() || "",
    ...
    try {
      ...
      if (imageId === "featured") {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/api/vehicles/${vehicleId}/images/featured`,
          {
            method: "DELETE",
            headers: {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      if (currentStep === 1) {
        ...
        if (formData.reconditioningCost)
          step2Data.reconditioning_cost = Number(formData.reconditioningCost);
        if (formData.accessoriesCost)
          step2Data.accessories_cost = Number(formData.accessoriesCost);
        if (formData.otherExpenses)
          step2Data.other_expenses = Number(formData.otherExpenses);
        if (formData.minimumSellingPrice)
          step2Data.minimum_selling_price = Number(
            formData.minimumSellingPrice,
          );

        const response = await api.updateVehicleDraft(
          token,
          vehicleId,
          step2Data,
        );
        if (response.success) {
          ...
          throw new Error(
            response.message || "Failed to save financial information",
          );
        }
        ...
        if (formData.engineNumber)
          formDataStep3.append("engine_number", formData.engineNumber);
        if (formData.chassisNumber)
          formDataStep3.append("chassis_number", formData.chassisNumber);
        ...
        if (formData.rcDocument)
          formDataStep3.append("rc_document", formData.rcDocument);
        if (formData.insuranceDocument)
          formDataStep3.append(
            "insurance_document",
            formData.insuranceDocument,
          );

        const response = await api.updateVehicleDraftWithFiles(
          token,
          vehicleId,
          formDataStep3,
        );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await api.updateVehicleStep4(
        token,
        vehicleId,
        step4Data,
      );
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Complete all steps to list your vehicle
          </p>
          {vehicleId && (
            <p className="text-sm text-primary mt-2">
              Vehicle ID:{" "}
              <span className="font-mono font-semibold">{vehicleId}</span>
            </p>
          )}
        </div>
              ...
              return (
                <div key={step.id} className="flex items-center flex-1">
                  <div className="flex flex-col items-center flex-1">
                    ...
                    <p
                      className={`text-sm font-medium mt-2 ${isActive ? "text-primary" : "text-gray-600"}`}
                    >
                      {step.name}
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("kilometers", e.target.value)
                        }
                        placeholder="50000"
                        className="input-field"
                      />
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("reconditioningCost", e.target.value)
                        }
                        placeholder="25000"
                        className="input-field"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("accessoriesCost", e.target.value)
                        }
                        placeholder="15000"
                        className="input-field"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("expectedSellingPrice", e.target.value)
                        }
                        placeholder="600000"
                        className="input-field"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("minimumSellingPrice", e.target.value)
                        }
                        placeholder="550000"
                        className="input-field"
                      />
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary transition">
                      {formData.rcDocument ? (
                        <div>
                          ...
                          <button
                            onClick={() => handleChange("rcDocument", null)}
                        ...
                        <>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              e.target.files &&
                              handleChange("rcDocument", e.target.files[0])
                            }
                          />
                          <label
                            htmlFor="rc-upload"
                      ...
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary transition">
                        {formData.insuranceDocument ? (
                          <div>
                            ...
                            <button
                              onClick={() =>
                                handleChange("insuranceDocument", null)
                              }
                              className="text-red-600 text-sm"
                            >
                              Remove
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      <span className="font-semibold text-primary">
                        {Object.values(uploadedImages).reduce(
                  ...
                  {!vehicleId && (
                    <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded-lg">
                      <p className="text-sm">
                        Please complete previous steps to upload images.
                      </p>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <div className="border-2 border-dashed border-primary rounded-lg p-6 text-center hover:border-primary-dark transition">
                      ...
                      uploadedImages.featured.length > 0 ? (
                        <div className="relative">
                          ...
                          <button
                            onClick={() =>
                              removeImage(
                                "featured",
                                uploadedImages.featured[0].id || "featured",
                              )
                            }
                          ...
                          {uploadingImages.featured ? (
                            ...
                            <>
                              ...
                              <p className="text-xs text-gray-500 mb-3">
                                This will be the main image shown on listings
                              </p>
                              <input
                                type="file"
                                accept="image/*"
                                onChange={(e) =>
                                  handleImageUpload("featured", e.target.files)
                                }
                                className="hidden"
                                id="featured-upload"
                                disabled={!vehicleId}
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={key} className="border rounded-lg p-4">
                        ...
                        {/* Preview Images */}
                        {uploadedImages[key] &&
                          uploadedImages[key].length > 0 && (
                            <div className="grid grid-cols-3 gap-2 mb-3">
                              {uploadedImages[key].map(
                                (img: any, idx: number) => (
                                  <div
                                    key={img.id || idx}
                        ...
                        <input
                          ...
                          multiple
                          onChange={(e) =>
                            handleImageUpload(key, e.target.files)
                          }
                          className="hidden"
                          id={`${key}-upload`}
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <input
                      ...
                      multiple
                      onChange={(e) =>
                        handleImageUpload("other", e.target.files)
                      }
                      className="hidden"
                      id="other-upload"
                  ...
                  <label className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("networkVisible", e.target.checked)
                      }
                      className="w-5 h-5"
                    />
                    <div>
                      <p className="font-semibold text-sm">
                        Make visible on network
                      </p>
                      <p className="text-xs text-gray-600">
                        Other dealers can see this listing
                      </p>
                    </div>
                  </label>
                </div>
            ...
            <div className="card p-6 sticky top-24">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold">
                    ₹{Number(formData.reconditioningCost || 0).toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Accessories</span>
                  <span className="font-semibold">
                    ₹{Number(formData.accessoriesCost || 0).toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Other Expenses</span>
                  <span className="font-semibold">
                    ₹{Number(formData.otherExpenses || 0).toLocaleString()}
                  </span>
                </div>
                ...
                <div className="border-t pt-3">
                  ...
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="font-semibold">
                      ₹
                      {Number(
                        formData.expectedSellingPrice || 0,
                      ).toLocaleString()}
                    </span>
                  </div>
